			...
			<div class="box-body">
				<div class="row clearfix">
						...
						<div class="form-group">
							<input type="text" name="turno_nombre" value="<?php echo ($this->input->post('turno_nombre') ? $this->input->post('turno_nombre') : $turno['turno_nombre']); ?>" class="form-control" id="turno_nombre" required/>
