          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="grupo_horanicio" value="<?php echo $this->input->post('grupo_horanicio'); ?>" class="form-control" id="grupo_horanicio" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="grupo_horafin" class="control-label">Grupo Horafin</label>
						<div class="form-group">
							<input type="text" name="grupo_horafin" value="<?php echo $this->input->post('grupo_horafin'); ?>" class="form-control" id="grupo_horafin" />
						</div>
					</div>
				</div>
			</div>
