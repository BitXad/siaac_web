    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Horario Edit</h3>
            </div>
			<?php echo form_open('horario/edit/'.$horario['horario_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="horario_desde" value="<?php echo ($this->input->post('horario_desde') ? $this->input->post('horario_desde') : $horario['horario_desde']); ?>" class="form-control" id="horario_desde" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="horario_hasta" class="control-label">Horario Hasta</label>
						<div class="form-group">
							<input type="text" name="horario_hasta" value="<?php echo ($this->input->post('horario_hasta') ? $this->input->post('horario_hasta') : $horario['horario_hasta']); ?>" class="form-control" id="horario_hasta" />
						</div>
					</div>
				</div>
			</div>
