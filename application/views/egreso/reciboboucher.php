    ...
    <tr>
        <td>
            ...
            <center>
                    ...
                    <!--<img src="<?php echo base_url('resources/images/').$institucion[0]['institucion_imagen']; ?>" width="100" height="60"><br>-->
                    <font size="3" face="Arial"><b><?php echo $institucion['institucion_nombre']; ?></b></font><br>
                    <!--<font size="2" face="Arial"><b><?php echo $institucion[0]['institucion_eslogan']; ?></b></font><br>-->
