    ...
    <tr>
        <td style="width: 40%; padding: 0; line-height:10px;" >
            ...
            <center>
                    ...
                    <img src="<?php echo base_url('resources/images/institucion/').$institucion['institucion_logo']; ?>" width="80px" height="60px"><br>
                    ...
                    <font size="1" face="Arial"><?php echo $institucion['institucion_direccion']; ?></font><br>
        ...
        <td style="width: 40%; padding: 20;line-height:15px;" > 
            <center>
                ...
                <font size="2" face="arial"><b>Nº: 00<?php echo $egresos[0]['egreso_numero']; ?></b></font> <br>
...
<div class="row" style="padding-left: 7%;padding-top: 0.5%">
     <font size="1" face="Arial"><b>Nº Trans.:</b> 00<?php echo $egresos[0]['egreso_id']; ?></font>              
</div>
</div>
