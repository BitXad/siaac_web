			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="number" min="0" name="carrera_tiempoestudio" value="<?php echo ($this->input->post('carrera_tiempoestudio') ? $this->input->post('carrera_tiempoestudio') : $carrera['carrera_tiempoestudio']); ?>" class="form-control" id="carrera_tiempoestudio" placeholder="0" />
						</div>
					</div>
				</div>
			</div>
