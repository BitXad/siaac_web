    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Aula Edit</h3>
            </div>
				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="aula_nombre" value="<?php echo ($this->input->post('aula_nombre') ? $this->input->post('aula_nombre') : $aula['aula_nombre']); ?>" class="form-control" id="aula_nombre" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="aula_capacidad" value="<?php echo ($this->input->post('aula_capacidad') ? $this->input->post('aula_capacidad') : $aula['aula_capacidad']); ?>" class="form-control" id="aula_capacidad" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="aula_tipo" class="control-label">Aula Tipo</label>
						<div class="form-group">
							<input type="text" name="aula_tipo" value="<?php echo ($this->input->post('aula_tipo') ? $this->input->post('aula_tipo') : $aula['aula_tipo']); ?>" class="form-control" id="aula_tipo" />
						</div>
					</div>
				</div>
			</div>
