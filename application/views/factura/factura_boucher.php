...
<!--        <td style="padding: 0; width: 0cm">-->
        <td style="padding: 0;" colspan="4">
            ...
            <center>
                    ...
                    <!--<img src="<?php echo base_url('resources/images/institucion/').$institucion['institucion_imagen']; ?>" width="100" height="60"><br>-->
                    ...
                    <!--<?php if (sizeof($institucion['institucion_propietario'])>0){ ?>
    ...
    <tr  style="border-top-style: solid; border-top-width: 2px; border-bottom-style: solid; border-bottom-width: 2px;" >
        <td colspan="4" style="padding: 0;  font-size: 9pt;">
                ...
                <?php $fecha = new DateTime($factura[0]['factura_fechaventa']); 
                  ...
                  ?>    
                    <b>LUGAR Y FECHA: </b><?php echo $institucion['institucion_departamento'].", ".$fecha_d_m_a." ".$factura[0]['factura_hora']; ?> <br>
