    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Nivel Add</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="plan_academico_id" class="form-control">
								...
								{
									$selected = ($plan_academico['plan_academico_id'] == $this->input->post('plan_academico_id')) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="nivel_descripcion" value="<?php echo $this->input->post('nivel_descripcion'); ?>" class="form-control" id="nivel_descripcion" />
						</div>
					</div>
				</div>
			</div>
