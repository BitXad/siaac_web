<!----------------------------- script buscador --------------------------------------->
<script src="<?php echo base_url('resources/js/reporte_deudas.js'); ?>" type="text/javascript"></script>
        ...
        <div class="box-tools">
            <div class=" col-md-11" style="padding: 0px;">
                    <div class="col-md-2" style="padding: 0px 10px 0px 0px;">
                        ...
                        <select  class="btn btn-primary btn-sm form-control" name="buscargestion_id" id="buscargestion_id" required>
                            <option value="0"> TODOS </option>
                            <?php foreach($all_gestion as $gestion){
                                $selected = ($gestion['gestion_id'] == $gestion_id) ? ' selected="selected"' : "";
                            ?>
                            <option value="<?php echo $gestion['gestion_id']; ?>" <?php echo $selected; ?>><?php echo $gestion['gestion_semestre']."/".$gestion['gestion_descripcion']; ?></option>
                            <?php } ?>
                        </select>
                        <?php /*}else{ ?>
                ...
                <div class="col-md-2" style="padding: 0px 10px 0px 0px">
                    DESDE: <input type="date" value="<?php echo $fecha_inicial; ?>" class="btn btn-primary btn-sm form-control" id="fecha_desde" name="fecha_desde" required="true">
                </div>
                <div class="col-md-2" style="padding: 0px 10px 0px 0px">
                    HASTA: <input type="date" value="<?php echo $fecha_final; ?>" class="btn btn-primary btn-sm form-control" id="fecha_hasta" name="fecha_hasta" required="true">
                </div>
                <!--<div class="col-md-2" style="padding: 0px 10px 0px 0px">
                    &nbsp;
                ...
                <div class="col-md-2" style="padding: 0px 10px 0px 0px">
                    <br>
                    <button class="btn btn-sm btn-warning btn-sm btn-block"  type="submit" onclick="buscar_deudas()" style="height: 34px;">
