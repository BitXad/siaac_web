    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Inscripcion Add</h3>
            </div>
          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="inscripcion_fecha" value="<?php echo $this->input->post('inscripcion_fecha'); ?>" class="has-datepicker form-control" id="inscripcion_fecha" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="inscripcion_hora" class="control-label">Inscripcion Hora</label>
						<div class="form-group">
							<input type="text" name="inscripcion_hora" value="<?php echo $this->input->post('inscripcion_hora'); ?>" class="form-control" id="inscripcion_hora" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="inscripcion_fechainicio" class="control-label">Inscripcion Fechainicio</label>
						<div class="form-group">
							<input type="text" name="inscripcion_fechainicio" value="<?php echo $this->input->post('inscripcion_fechainicio'); ?>" class="has-datepicker form-control" id="inscripcion_fechainicio" />
						</div>
					</div>
				</div>
			</div>
