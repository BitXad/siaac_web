      	...
      	<div class="box box-info">
            ...
            <div class="box-body" style="margin-top: 0px;margin-bottom: -20px; background: rgba(0, 0, 255, 0.3);"><u><b>CONFIGURACION</b></u><br>
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <select  name="parametro_tipoimpresora"  class="form-control" id="parametro_tipoimpresora" >
                            ...
                            <option value="MEDIO OFICIO CON COPIA" <?php if($parametro['parametro_tipoimpresora']=='MEDIO OFICIO CON COPIA'){ ?> selected <?php } ?> >MEDIO OFICIO CON COPIA</option>
                        </select>
                    </div>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        <input type="date" name="parametro_fechainicio" value="<?php echo ($this->input->post('parametro_fechainicio') ? $this->input->post('parametro_fechainicio') : $parametro["parametro_fechainicio"]); ?>" class="form-control" id="parametro_fechainicio" />
                    </div>
                </div>
            </div><hr>
