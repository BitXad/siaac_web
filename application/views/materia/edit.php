<div class="row">
    <div class="col-md-12">
      	<div class="box box-info">
			...
			<?php echo form_open('materia/edit/'.$materia['materia_id']); ?>
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<select name="mat_materia_id" class="form-control">
								...
								{
									$selected = ($materia['materia_id'] == $materia['mat_materia_id']) ? ' selected="selected"' : "";
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="materia_hp" value="<?php echo ($this->input->post('materia_hp') ? $this->input->post('materia_hp') : $materia['materia_hp']); ?>" class="form-control" id="materia_hp" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="materia_ht" class="control-label">Materia Ht</label>
						<div class="form-group">
							<input type="text" name="materia_ht" value="<?php echo ($this->input->post('materia_ht') ? $this->input->post('materia_ht') : $materia['materia_ht']); ?>" class="form-control" id="materia_ht" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="materia_th" class="control-label">Materia Th</label>
						<div class="form-group">
							<input type="text" name="materia_th" value="<?php echo ($this->input->post('materia_th') ? $this->input->post('materia_th') : $materia['materia_th']); ?>" class="form-control" id="materia_th" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="materia_cyp" class="control-label">Materia Cyp</label>
						<div class="form-group">
							<input type="text" name="materia_cyp" value="<?php echo ($this->input->post('materia_cyp') ? $this->input->post('materia_cyp') : $materia['materia_cyp']); ?>" class="form-control" id="materia_cyp" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="materia_cys" class="control-label">Materia Cys</label>
						<div class="form-group">
							<input type="text" name="materia_cys" value="<?php echo ($this->input->post('materia_cys') ? $this->input->post('materia_cys') : $materia['materia_cys']); ?>" class="form-control" id="materia_cys" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="materia_vtt" class="control-label">Materia Vtt</label>
						<div class="form-group">
							<input type="text" name="materia_vtt" value="<?php echo ($this->input->post('materia_vtt') ? $this->input->post('materia_vtt') : $materia['materia_vtt']); ?>" class="form-control" id="materia_vtt" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="materia_ctp" class="control-label">Materia Ctp</label>
						<div class="form-group">
							<input type="text" name="materia_ctp" value="<?php echo ($this->input->post('materia_ctp') ? $this->input->post('materia_ctp') : $materia['materia_ctp']); ?>" class="form-control" id="materia_ctp" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="materia_numareas" value="<?php echo ($this->input->post('materia_numareas') ? $this->input->post('materia_numareas') : $materia['materia_numareas']); ?>" class="form-control" id="materia_numareas" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="materia_notainstancia" class="control-label">Materia Notainstancia</label>
						<div class="form-group">
							<input type="text" name="materia_notainstancia" value="<?php echo ($this->input->post('materia_notainstancia') ? $this->input->post('materia_notainstancia') : $materia['materia_notainstancia']); ?>" class="form-control" id="materia_notainstancia" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="materia_notaaprobado" class="control-label">Materia Notaaprobado</label>
						<div class="form-group">
							<input type="text" name="materia_notaaprobado" value="<?php echo ($this->input->post('materia_notaaprobado') ? $this->input->post('materia_notaaprobado') : $materia['materia_notaaprobado']); ?>" class="form-control" id="materia_notaaprobado" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="materia_maxima" class="control-label">Materia Maxima</label>
						<div class="form-group">
							<input type="text" name="materia_maxima" value="<?php echo ($this->input->post('materia_maxima') ? $this->input->post('materia_maxima') : $materia['materia_maxima']); ?>" class="form-control" id="materia_maxima" />
						</div>
					</div>
					<div class="col-md-6">
