          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="rol_nombre" value="<?php echo $this->input->post('rol_nombre'); ?>" class="form-control" id="rol_nombre" />
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="rol_descripcion" value="<?php echo $this->input->post('rol_descripcion'); ?>" class="form-control" id="rol_descripcion" />
						</div>
					</div>
				</div>
			</div>
