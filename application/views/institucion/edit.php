			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="institucion_fechacreacion" value="<?php echo ($this->input->post('institucion_fechacreacion') ? $this->input->post('institucion_fechacreacion') : $institucion['institucion_fechacreacion']); ?>" class="has-datepicker form-control" id="institucion_fechacreacion" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="institucion_logo" class="control-label">Institucion Logo</label>
						<div class="form-group">
							<input type="text" name="institucion_logo" value="<?php echo ($this->input->post('institucion_logo') ? $this->input->post('institucion_logo') : $institucion['institucion_logo']); ?>" class="form-control" id="institucion_logo" />
						</div>
					</div>
					<div class="col-md-6">
