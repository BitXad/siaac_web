          	...
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="date" name="institucion_fechacreacion" value="<?php echo $this->input->post('institucion_fechacreacion'); ?>" class="form-control" id="institucion_fechacreacion" />
						</div>
					</div>
					<div class="col-md-6">
						<label for="institucion_logo" class="control-label">Logo</label>
						<div class="form-group">
                                                    <input type="file" name="institucion_logo" value="<?php echo $this->input->post('institucion_logo'); ?>" class="form-control" id="institucion_logo" accept="image/png, image/jpeg, jpg, image/gif" />
						</div>
					</div>
					<div class="col-md-6">
