				...
				<div class="row clearfix">
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="estadocivil_descripcion" value="<?php echo ($this->input->post('estadocivil_descripcion') ? $this->input->post('estadocivil_descripcion') : $estado_civil['estadocivil_descripcion']); ?>" class="form-control" id="estadocivil_descripcion" required/>
