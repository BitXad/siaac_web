...
function buscar_deudas(){
    ...
    var gestion_id = document.getElementById('buscargestion_id').value;
    
    var controlador = base_url+"reportes/buscarlasdeudas";
    document.getElementById('loader').style.display = 'block'; //muestra el bloque del loader
    
    $.ajax({url: controlador,
           type:"POST",
           data:{fecha1:fecha_desde, fecha2:fecha_hasta, gestion_id:gestion_id},
