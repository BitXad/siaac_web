function mostrarmodalpagar(mensualidad){
    ...
    var eldescuento = "<input type='number' onkeyup='descontar("+mensualidad["mensualidad_id"]+")' name='mensualidad_descuento' value='0' min='0' step='any' class='form-control' id='mensualidad_descuento"+mensualidad["mensualidad_id"]+"' />";
    ...
    var elmontocancelado = "<input type='number' step='any' onkeyup='calcular("+mensualidad["mensualidad_id"]+")' name='mensualidad_montocancelado' value='"+Number(Number(mensualidad["mensualidad_montoparcial"])+Number(mensualidad["mensualidad_multa"])).toFixed(2)+"' class='form-control' id='mensualidad_montocancelado"+mensualidad["mensualidad_id"]+"' min='0'/>";
    ...
    var lamensualidadsaldo = "<input type='number' step='any' name='mensualidad_saldo' value='0.00' class='form-control' id='mensualidad_saldo"+mensualidad["mensualidad_id"]+"' />";
